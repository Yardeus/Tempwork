...
export default compose(
    connect(mapStateToProps, {getWorkersFromMyVacancy,SetCurrentRespondVacancyId,FormRespondedMyVacancy, createAgreement,  setFeedbackMode, setFeedbackSendMode,sendFeedbackEmployer})
